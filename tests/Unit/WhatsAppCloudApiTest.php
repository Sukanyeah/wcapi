...
namespace Sukanyeah\WhatsAppCloudApi\Tests\Unit;

use GuzzleHttp\Psr7;
use Sukanyeah\WhatsAppCloudApi\Client;
use Sukanyeah\WhatsAppCloudApi\Http\ClientHandler;
use Sukanyeah\WhatsAppCloudApi\Http\RawResponse;
...
use Sukanyeah\WhatsAppCloudApi\Response\ResponseException;
...
final class WhatsAppCloudApiTest extends TestCase
{
    ...
    public function test_upload_media()
    {
        ...
        $form = [
            [
                'name' => 'file',
                'contents' => Psr7\Utils::tryFopen('tests/Support/sukanyeah.png', 'r'),
            ],
            [
                'name' => 'type',
                'contents' => 'image/png',
