...
$whatsapp_cloud_api->sendTemplate('919876543210', 'hello_world', 'en_US'); // If not specified, Language will be default to en_US and otherwise it will be required.
```
...
The `Webhook::read` function will return a `Notification` instance. Please, [explore](https://github.com/sukanyeah/wcapi/tree/main/src/WebHook/Notification "explore") the different notifications availables.
...
## Getting Help
- Ask a question on the [Discussions forum](https://github.com/sukanyeah/wcapi/discussions "Discussions forum")
- To report bugs, please [open an issue](https://github.com/sukanyeah/wcapi/issues/new/choose "open an issue")

## Changelog

Please see [CHANGELOG](https://github.com/sukanyeah/wcapi/blob/main/CHANGELOG.md "CHANGELOG") for more information what has changed recently.
...
Please see [CONTRIBUTING](https://github.com/sukanyeah/.github/blob/master/CONTRIBUTING.md "CONTRIBUTING") for details.

## License

The MIT License (MIT). Please see License File for more information. Please see [License file](https://github.com/sukanyeah/wcapi/blob/main/LICENSE "License file") for more information.
